...
type SearchPostVO struct {
	...
	CreatedAt     string                 `protobuf:"bytes,12,opt,name=created_at,json=createdAt,proto3" json:"created_at,omitempty"` // 透传 ES 中的帖子创建时间
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *SearchPostVO) GetCreatedAt() string {
	if x != nil {
		return x.CreatedAt
	}
	return ""
...
const file_proto_search_search_proto_rawDesc = "" +
	...
	"\auser_id\x18\x06 \x01(\x03R\x06userId\"\xd1\x02\n" +
